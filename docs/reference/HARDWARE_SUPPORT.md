...
|---|---|---|---|---|
| Backward dense D=64 non-causal qL≥2048 | `mx.vjp(SDPA)` | `mx.vjp(SDPA)` | **V6NAX NAX-direct** (DEFAULT-ON, fused-BK16) | **(A)** **M5/MLX-0.31.2 (2026-06-19): 2.55× @qL4096 / 3.76× @qL8192 vs SDPA-vjp** (B=1 H=4 fp16, byteΔ-confirmed). Pre-M5 (v2.39.1): 2.00×/1.95×/1.72×. |
...
| Backward causal **D=64** qL≥2048 | `mx.vjp(SDPA)` | `mx.vjp(SDPA)` | **V6NAX NAX-direct** (DEFAULT-ON, post-Prompt 4 multi-gate fix) | **(A)** production-active — **M5/MLX-0.31.2 (2026-06-19): 4.88× @qL4096 / 5.75× @qL8192 vs SDPA-vjp** (B=1 H=4 fp16, byteΔ-confirmed; causal SDPA-vjp is slow → biggest V6 win). Never carried a documented 2× before this measurement. |
